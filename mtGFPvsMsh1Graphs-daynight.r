...
#Summary Statistics Graphs for MSH1 mitochondrial dynamics manuscript (Day/Night comparisons)

# Each graph is saved using ggsave, if you need, just uncomment these lines for the graphs you need.
...
dataFileNames<-c(rep(paste("mtgfp-day/mtgfpday-",1:13,".xml",sep=""),1:13,13),rep(paste("mtgfp-night/mtgfpnight-",1:13,".xml",sep=""),1:13,13),rep(paste("msh1-day/msh1day-",1:13,".xml",sep=""),1:13,13),rep(paste("msh1-night/msh1night-",1:13,".xml",sep=""),1:13,13))

#list all names of videos
dataFrameNames<-c(rep(paste("GFPday",1:13,sep=""),1:13,13),rep(paste("GFPnight",1:13,sep=""),1:13,13),rep(paste("MSHday",1:13,sep=""),1:13,13),rep(paste("MSHnight",1:13,sep=""),1:13,13))

#list their scientific names
type<-c(rep("mtGFP_day",length(grep("GFPday[0-9]",dataFrameNames))),rep("mtGFP_night",length(grep("GFPnight[0-9]",dataFrameNames))),rep("msh1_day",length(grep("MSHday[0-9]",dataFrameNames))),rep("msh1_night",length(grep("MSHnight[0-9]",dataFrameNames)))) 
...
mypalette = c("#fed8b1", "#ff8c00", "#add8e6", "#00008B")
#=================================
#physical statistics
#=================================
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
if(kt$p.value < 0.05){
  ...
  #ggsave(paste("speedMeanPlot-DayNight.pdf",sep=""),speedplot,width = 10, height=16, units = "cm")
...
if(kt$p.value < 0.05){
  ...
  #ggsave(paste("colocMeanPlot-DayNight.pdf",sep=""),colocplot,width = 10, height=16, units = "cm")
...
for(f in c(5,10,50,100,120)){
  ...
  if(kt$p.value < 0.05){
    ...
    #ggsave(paste("distsMeanPlotFrame-DayNight",f,".pdf",sep=""),distsplot,width = 10, height=16, units = "cm")
...
if(kt$p.value < 0.05){
  ...
  #ggsave(paste("distsMeanofMeansPlot-DayNight.pdf",sep=""),overalldistsplot,width = 10, height=16, units = "cm")
...
degplots<-function(frames){
  ...
  for(f in frames){
    ...
    if(kt$p.value < 0.05){
      ...
      ggsave(paste("degreeMeansPlotFrame-DayNight",f,".pdf",sep=""),degreeplot,width = 10, height=16, units = "cm")
...
deg
#ggsave(paste("FigureS7PartA-DayNight.png",sep=""),deg,width = 10, height=45, units = "cm")
...
effplots<-function(frames){
  ...
  for(f in frames){
    ...
    if(kt$p.value < 0.05){
      ...
      #ggsave(paste("efficiencyMeansPlotFrame-DayNight",f,".pdf",sep=""),efficiencyplot,width = 10, height=16, units = "cm")
...
eff <-ggarrange(plotlist=effplots(c(10,50,100)), labels = c("B.i","B.ii","B.iii"),
                ...
                ncol = 1 ,font.label = list(size = 18))
eff
#ggsave(paste("FigureS7PartB-DayNight.png",sep=""),eff,width = 10, height=45, units = "cm")
...
diaplots<-function(frames){
  ...
  for(f in frames){
    ...
    if(kt$p.value < 0.05){
      ...
      #ggsave(paste("diameterPlotFrame-DayNight",f,".pdf",sep=""),diameterplot,width = 10, height=16, units = "cm")
...
dia <-ggarrange(plotlist=diaplots(c(10,50,100)), labels = c("C.i","C.ii","C.iii"),
                ...
                ncol = 1 ,font.label = list(size = 18))
dia
#ggsave(paste("FigureS7PartC-DayNight.png",sep=""),dia,width = 10, height=45, units = "cm")
...
bcplots<-function(frames){
  ...
  for(f in frames){
    ...
    if(kt$p.value < 0.05){
      ...
      #ggsave(paste("bcPlotFrame-DayNight",f,".pdf",sep=""),bcplot,width = 10, height=16, units = "cm")
...
bc <-ggarrange(plotlist=bcplots(c(10,50,100)), labels = c("D.i","D.ii","D.iii"),
               ...
               ncol = 1 ,font.label = list(size = 18))
bc
#ggsave(paste("FigureS7PartD-DayNight.png",sep=""),bc,width = 10, height=45, units = "cm")
...
ggsave(paste("Figure4-DayNight.png",sep=""), fig4, width = 45, height=30, units = "cm")
ggsave(paste("Figure4-DayNight.pdf",sep=""), fig4, width = 45, height=30, units = "cm")
...
nodeplots<-function(){
  ...
  for(f in c(10,50,100,120)){
    ...
    if(kt$p.value < 0.05){
      ...
      #ggsave(paste("NodeNumberPlotFrame-DayNight",f,".pdf",sep=""),nodeplot,width = 10, height=16, units = "cm")
...
n
#ggsave(paste("NodeNumberPlotFramesTogether-daynight.png",sep=""),n,width = 35, height=15, units = "cm")
...
edgeplots<-function(){
  ...
  for(f in c(10,50,100,120)){
    ...
    if(kt$p.value < 0.05){
      ...
      #ggsave(paste("EdgeNumberPlotFrame-DayNight",f,".pdf",sep=""),edgeplot,width = 10, height=16, units = "cm")
...
e <-ggarrange(plotlist=edgeplots(), labels = c("B.i","B.ii","B.iii","B.iv"),
              ...
              ncol = 4 ,font.label = list(size = 18) , hjust=0.01 ,vjust=3)
e
#ggsave(paste("EdgeNumberPlotFramesTogether-DayNight.png",sep=""),e,width = 35, height=15, units = "cm")
